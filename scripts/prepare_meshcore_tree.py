#!/usr/bin/env python3
"""
Prepare an upstream MeshCore checkout to build the RAK4631 Ethernet Companion target.
...
TARGET_ENV = "RAK_4631_companion_radio_eth"
...
def patch_rak4631_variant(meshcore: Path) -> None:
    ...
    new_spi_count = """#ifdef WITH_ETHERNET_TCP_API
